...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.train_scale==1:
        ...
        optimizer = torch.optim.SGD([{'params': base_params}, {'params': avg_params, 'lr': 0.001}], lr=args.lr, momentum=args.momentum)
    else:
    ...
    train_loader, num_class = utils.get_trainloader('', 
                                        ...
                                        32,
                                        args.batch_size,args.outliers,args.train_outlier)
    #utils.create_val_img_folder('./data/tiny-imagenet-200/val')
    val_loader, _ = utils.get_testloader('', 
                                        './data/tiny-imagenet-200/val',
                                        32,
                                        args.batch_size,args.outliers,1)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #train_acc1=validate(train_loader, model, criterion, epoch, args)
        train_acc1=0
